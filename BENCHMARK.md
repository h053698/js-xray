...
| 개선 지표 | B: xrayjs + xq | C: xrayjs + xq + 스킬 |
|---|---:|---:|
| 시간 단축 | 57.5% (2.35배 빠름) | **63.1% (2.71배 빠름)** |
| 총 토큰 절감 | **74.5% (3.92배 효율)** | 72.2% (3.60배 효율) |
| API 비용 절감 | **74.2% ($13.48 절약)** | 71.9% ($13.07 절약) |
| 툴 호출 감소 | 50.6% | 50.6% |
| 피크 컨텍스트 감소 | **54.2%** | 48.7% |
| 구현 시작 시점 | **8.44배 일찍** | 6.33배 일찍 |

**C는 가장 빠른 조건입니다:** 16분 5초가 5분 56초로 줄었습니다. **B는 가장 경제적인 조건입니다:** 총 토큰 74.5% 절감, 비용 74.2% 절감. C는 B보다 토큰 9.0%, 비용 8.7%를 더 사용했지만 전체 작업을 13.2% 더 빨리 완료했습니다.

![js-xray A/B/C 벤치마크 요약](assets/benchmark-summary.svg)
